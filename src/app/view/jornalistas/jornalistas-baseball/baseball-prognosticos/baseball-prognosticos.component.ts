...
@Component({
  selector: 'app-baseball-prognosticos',
  templateUrl: './baseball-prognosticos.component.html',
  styleUrls: ['./baseball-prognosticos.component.scss']
})

export class BaseballPrognosticosComponent implements OnInit {
